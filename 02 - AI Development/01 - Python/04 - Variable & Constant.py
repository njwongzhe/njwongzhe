...
# Data type in python include int, float, str, boolean, list, tuple, dict, set, etc.

x = 10            # x is an integer (int)
print(f"x = {x}") # Output: x = 10

x = "Hello"       # x is reassigned to a string (str).
...
PI = 3.14159 # Developers use uppercase letters to signal that a variable should NOT be modified.
PI = 3.14    # Technically, Python still allows you to change it. No interpreter error, but discouraged by convention.
